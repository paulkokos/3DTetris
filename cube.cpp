...
cube::cube() { active = 0; loaded=0; }
void cube::setColour(int randNum) { colour=randNum; }
void cube::setPos(int indexX, int indexY, int indexZ) { posX=indexX; posY=indexY; posZ=indexZ; }
void cube::movePos(int x, int y, int z) { posX=x; posY=y; posZ=z; }
